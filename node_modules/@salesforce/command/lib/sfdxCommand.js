...
class SfdxCommand extends command_1.default {
    ...
    async catch(err) {
        ...
        const userDisplayError = Object.assign(this.getJsonResultObject(error.data, error.exitCode), Object.assign({}, error.toObject(), { stack: error.stack, warnings: ux_1.UX.warnings }));
        if (this.isJson) {
            // This should default to true, which will require a major version bump.
            const sendToStdout = kit_1.env.getBoolean('SFDX_JSON_TO_STDOUT');
            if (sendToStdout) {
