...
export declare namespace flags {
    ...
    type Option<T> = Partial<IOptionFlag<Optional<T>>> & SfdxProperties;
...
declare function buildOption<T>(options: {
    parse: (val: string, context: unknown) => T;
...
declare function buildArray(options: flags.Array): flags.Discriminated<flags.Array>;
...
export declare const optionalBuiltinFlags: {
    apiversion(opts?: flags.Builtin | undefined): flags.Discriminated<flags.Option<string>>;
    ...
    targetdevhubusername(opts?: flags.Builtin | undefined): flags.Discriminated<flags.Option<string>>;
    targetusername(opts?: flags.Builtin | undefined): flags.Discriminated<flags.Option<string>>;
